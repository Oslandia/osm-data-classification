...
tlnodes = read.csv("~/data/bordeaux-metropole/latest-bordeaux-metropole-node-timeline.csv",stringsAsFactors = F)
tlways = read.csv("~/data/bordeaux-metropole/latest-bordeaux-metropole-way-timeline.csv",stringsAsFactors = F)
tlrelations = read.csv("~/data/bordeaux-metropole/latest-bordeaux-metropole-relation-timeline.csv",stringsAsFactors = F)
```
